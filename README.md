...
[![KDoc](https://javadoc.io/badge2/cloud.drakon/ktuniversalis/6.0.0-SNAPSHOT/KDoc.svg)](https://javadoc.io/doc/cloud.drakon/ktuniversalis/6.0.0-SNAPSHOT)
...
```kotlin
dependencies {
    implementation("cloud.drakon:ktuniversalis:6.0.0-SNAPSHOT")
}
```
